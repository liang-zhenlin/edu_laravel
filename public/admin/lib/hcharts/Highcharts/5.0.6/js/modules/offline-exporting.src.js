    ...
    (function (Highcharts) {
        ...
        Highcharts.svgToDataUrl = function (svg) {
            var webKit =
                ...
                nav.userAgent.indexOf("Chrome") < 0; // Webkit and not chrome
            try {
                // Safari requires data URI since it doesn't allow navigation to blob URLs
                // Firefox has an issue with Blobs and internal references, leading to gradients not working using Blobs (#4550)
                if (
                    !webKit &&
                    nav.userAgent.toLowerCase().indexOf("firefox") < 0
                ) {
        ...
        Highcharts.downloadSVGLocal = function (
            ...
            var svgurl,
                ...
                libURL =
                    options.libURL || Highcharts.getOptions().exporting.libURL,
            ...
            function downloadPDF() {
                ...
                var textElements =
                    ...
                    titleElements,
                    svgElementStyle =
                        dummySVGContainer.getElementsByTagName("svg")[0].style;
